...
class ClassificationAgent():
    ...
    def get_response(self,messages):
        ...
        system_prompt = """
            ...
            1. details_agent: This agent is responsible for answering questions about the coffee shop, like location, delivery places, working hours, details about menue items. Or listing items in the menu items. Or by asking what we have.It is not responsible to take orders.
            2. order_taking_agent: This agent is strictly responsible for taking orders from the user. It's responsible to have a conversation with the user about the order untill it's complete.
